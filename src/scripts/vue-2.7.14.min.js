...
!(function (t, e) {
          ...
          var e,
            ...
            r =
              null === (e = this._collection) || void 0 === e
                ...
                : e.indexOf(t);
          r > -1 &&
            (null === (n = this._collection) || void 0 === n || n.splice(r, 1));
        }),
        (t.prototype.toArray = function () {
    ...
    _t = (function () {
      ...
      return (
        ...
        (t.prototype.notify = function (t) {
          ...
          for (var n = 0, r = (e = this.subs.toArray()).length; n < r; n++) {
            e[n].update();
          }
        }),
        t
      ...
      return (
        Object.defineProperty(t, n, {
          ...
          get: function () {
            var n = u ? u.call(t) : r;
            return (
              _t.target && (s.depend(), f && (f.dep.depend(), e(n) && Mt(n))),
              Bt(n) && !i ? n.value : n
            );
          },
          set: function (e) {
  ...
  function Pt(t, n, r) {
    if (!Ht(t)) {
      ...
      return e(t) && l(n)
        ...
        ? r
        : o
        ? (Nt(o.value, n, r, void 0, o.shallow, o.mock), o.dep.notify(), r)
        : ((t[n] = r), r);
    }
  }
  function Dt(t, n) {
  ...
  function qt(t, e) {
    ...
    for (var i = Object.keys(t), a = 0; a < i.length; a++) Wt(o, t, i[a], e);
    return o;
  }
  function Wt(t, e, n, r) {
    Object.defineProperty(t, n, {
        ...
        ? ((m = !0),
          ...
          (f = function () {
            return n.map(function (t) {
              return Bt(t) ? t.value : Rt(t) ? Vn(t) : a(t) ? v(t, an) : void 0;
            });
          }))
        : (f = a(n)
            ? r
              ...
              : function () {
                  if (!d || !d._isDestroyed) return p && p(), v(n, rn, [y]);
                }
            : j),
      r && c)
    ) {
          ...
          if (r) {
            ...
            (c ||
              ...
              (m
                ...
                : I(t, b))) &&
              (p && p(), v(r, on, [t, b === ln ? void 0 : b, y]), (b = t));
          } else _.get();
      }),
      "sync" === l
        ? (_.update = _.run)
    ...
    n.computed &&
      (function (t, e) {
        ...
        for (var o in e) {
          var i = e[o],
            s = a(i) ? i : i.get;
          r || (n[o] = new qn(t, s || j, j, Xn)), o in t || Yn(t, o, i);
        }
      })(t, n.computed),
      n.watch &&
        n.watch !== tt &&
  ...
  var ur = {
      ...
      prepatch: function (e, n) {
        ...
        !(function (e, n, r, o, i) {
          ...
          if (
            ...
            Tt(!1);
            for (
              var d = e._props, v = e.$options._propKeys || [], h = 0;
              h < v.length;
              h++
            ) {
              var m = v[h],
      ...
      insert: function (t) {
        ...
        r._isMounted || ((r._isMounted = !0), Ve(r, "mounted")),
          t.data.keepAlive &&
            (n._isMounted ? (((e = r)._inactive = !1), Je.push(e)) : Be(r, !0));
      },
      destroy: function (t) {
      ...
      if ((s(i) && (i = p.extend(i)), "function" == typeof i)) {
          ...
          ((i = (function (t, e) {
            ...
            if (i && !r(t.owners)) {
              ...
              var p = function (t) {
                ...
                d = M(function (n) {
                  (t.resolved = Pe(n, e)), c ? (a.length = 0) : p(!0);
                }),
                v = M(function (e) {
        ...
        if (o(i.options.functional))
          return (function (n, o, i, a, s) {
            ...
            if (e(d)) {
              for (
                var v = te(d) || [], h = new Array(v.length), m = 0;
                m < v.length;
                m++
              )
        ...
        !(function (t) {
          for (var e = t.hook || (t.hook = {}), n = 0; n < lr.length; n++) {
            var r = lr[n],
              o = e[r],
              i = ur[r];
            o === i || (o && o._merged) || (e[r] = o ? pr(i, o) : i);
          }
        })(a);
  ...
  function hr(t, e, n) {
    ...
    for (
      ...
      "__ob__" !== (r = a[s]) &&
        ((o = t[r]),
        (i = e[r]),
        n && _(t, r) ? o !== i && u(o) && u(i) && hr(o, i) : Pt(t, r, i));
    return t;
  }
  function mr(t, e, n) {
    return n
  ...
  !(function (t) {
    ...
    Object.defineProperty(t, "config", e),
      (t.util = { warn: dr, extend: T, mergeOptions: br, defineReactive: Nt }),
      (t.set = Pt),
      (t.delete = Dt),
      (t.nextTick = On),
  ...
  function bo(t, e) {
    ...
    if (
      ...
      for (a in ((W || G) && l.value !== u.value && $o(c, "value", l.value), u))
        n(l[a]) &&
          (zr(a)
        ...
        if (e)
          for (var o = t; o.componentInstance; )
            (o = o.componentInstance._vnode) &&
              ...
              T(r, n);
        (n = di(t.data)) && T(r, n);
        for (var i = t; (i = i.parent); ) i.data && (n = di(i.data)) && T(r, n);
        return r;
      })(e, !0);
                ...
                a &&
                  ...
                  a.sync &&
                    ...
                    c
                      ...
                      : (Bo(t, "update:".concat(w(r)), s, null, !1, 0, u[e]),
                        k(r) !== w(r) &&
                          Bo(
                            t,
                            "update:".concat(k(r)),
            ...
            Lo(
              ...
              Bo(
                ...
                "var $$a=".concat(e, ",") +
                  ...
                  "else{$$i>-1&&(".concat(
                    Wo(e, "$$a.slice(0,$$i).concat($$a.slice($$i+1))"),
                    ")}"
                  ) +
                  "}else{".concat(Wo(e, "$$c"), "}"),
                null,
